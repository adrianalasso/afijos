 ...
 */
class Canton extends \afijos\MainBundle\Entity\Canton implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'afijos\\MainBundle\\Entity\\Canton' . "\0" . 'id', '' . "\0" . 'afijos\\MainBundle\\Entity\\Canton' . "\0" . 'nombre', '' . "\0" . 'afijos\\MainBundle\\Entity\\Canton' . "\0" . 'provincia');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Canton $proxy) {
