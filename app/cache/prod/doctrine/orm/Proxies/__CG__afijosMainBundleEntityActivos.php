 ...
 */
class Activos extends \afijos\MainBundle\Entity\Activos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'id', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'codigo', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'etiqueta', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'estado', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'eliminado', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'observaciones', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'historico', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'fechaRegistro', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'fechAdquisicion', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'fechaMarcha', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'tipoDocumento', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'numeroDocumento', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'procedencia', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'financiamiento', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'bienAsegurable', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'calidad', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'factorEstado', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'valorHistorico', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'valorAdquisicion', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'valorResidual', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'valorDepreciable', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'valorDepreciacionAcumulada', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'ultimaFechaDepreciacion', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'valorLibros', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'unidadPropiedad', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'agencia', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'areaOperativa', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'canton', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'cuentaContable', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'departamento', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'dependencia', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'plan', '' . "\0" . 'afijos\\MainBundle\\Entity\\Activos' . "\0" . 'trabajador');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Activos $proxy) {
