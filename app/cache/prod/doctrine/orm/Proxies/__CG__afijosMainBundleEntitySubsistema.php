 ...
 */
class Subsistema extends \afijos\MainBundle\Entity\Subsistema implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'afijos\\MainBundle\\Entity\\Subsistema' . "\0" . 'id', '' . "\0" . 'afijos\\MainBundle\\Entity\\Subsistema' . "\0" . 'codigo', '' . "\0" . 'afijos\\MainBundle\\Entity\\Subsistema' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Subsistema $proxy) {
