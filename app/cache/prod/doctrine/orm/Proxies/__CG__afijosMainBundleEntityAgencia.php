 ...
 */
class Agencia extends \afijos\MainBundle\Entity\Agencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'afijos\\MainBundle\\Entity\\Agencia' . "\0" . 'id', '' . "\0" . 'afijos\\MainBundle\\Entity\\Agencia' . "\0" . 'nombre');
        }
