 ...
 */
class Empleado extends \afijos\MainBundle\Entity\Empleado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'afijos\\MainBundle\\Entity\\Empleado' . "\0" . 'id', '' . "\0" . 'afijos\\MainBundle\\Entity\\Empleado' . "\0" . 'apellidos', '' . "\0" . 'afijos\\MainBundle\\Entity\\Empleado' . "\0" . 'nombres');
        }
