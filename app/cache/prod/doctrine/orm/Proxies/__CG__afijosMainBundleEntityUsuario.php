 ...
 */
class Usuario extends \afijos\MainBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'username', 'password', 'salt', 'userRoles');
        }
    ...
    public function addUserRoles(\afijos\MainBundle\Entity\Rol $roles)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addUserRoles', array($roles));

        return parent::addUserRoles($roles);
    }
