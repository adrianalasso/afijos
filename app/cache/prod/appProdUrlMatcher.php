    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/')) {
            ...
            if (0 === strpos($pathinfo, '/empadmin/reportes')) {
                ...
                // reportes_rform11
                if ($pathinfo === '/empadmin/reportes/rform11') {
                    return array (  '_controller' => 'afijos\\MainBundle\\Controller\\ReportesController::rform11Action',  '_route' => 'reportes_rform11',);
                }
                ...
                // reportes_reporte9
                if ($pathinfo === '/empadmin/reportes/reporte9') {
                    return array (  '_controller' => 'afijos\\MainBundle\\Controller\\ReportesController::reporte9Action',  '_route' => 'reportes_reporte9',);
                }

                // reportes_reporte10
                if ($pathinfo === '/empadmin/reportes/reporte10') {
                    return array (  '_controller' => 'afijos\\MainBundle\\Controller\\ReportesController::reporte10Action',  '_route' => 'reportes_reporte10',);
                }

                // reportes_reporte11
                if (preg_match('#^/empadmin/reportes/(?P<fechastr>[^/]+)/reporte11$#s', $pathinfo, $matches)) {
                    return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'afijos\\MainBundle\\Controller\\ReportesController::reporte11Action',)), array('_route' => 'reportes_reporte11'));
                }
