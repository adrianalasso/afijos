...
/* MainBundle:AreaOperativa:index.html.twig */
class __TwigTemplate_d60a0de336b3c7f03f61760f0fbc2d96106b7ff13587c3e381fa1129ac2adb06 extends Twig_Template
{
    ...
    {
        echo "href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("areaoperativa_new"), "html", null, true);
        echo "\"";
    }
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            // line 18
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("areaoperativa_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
            ...
            echo "\">
                    ...
                    <a class=\"green\" href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("areaoperativa_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">
...
window.onload = function(){
    var elemento=document.getElementById(\"mnareaoperativas\");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            bootbox.confirm(\"Estas seguro de eliminar registro?\", function(result) {
                if(result){
                    location.href=\"";
            // line 56
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("areaoperativa_eliminar", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\";
                }
            });
    });
...
";
    ...
    {
        return "MainBundle:AreaOperativa:index.html.twig";
    }
