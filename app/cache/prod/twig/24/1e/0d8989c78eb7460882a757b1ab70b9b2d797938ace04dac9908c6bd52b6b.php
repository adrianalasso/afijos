...
/* MainBundle:Reportes:rform4.html.twig */
class __TwigTemplate_241e0d8989c78eb7460882a757b1ab70b9b2d797938ace04dac9908c6bd52b6b extends Twig_Template
{
...
jQuery(document).ready(function() {
    var elemento=document.getElementById(\"mnrp4\");
...
\$(\"#btaceptar\").click(function(){    
    var lsubtrans = \$('#lsubtransmision_type_subtransmision').val();
    if(lsubtrans!=\"\"){
        var url=\"";
        // line 82
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("reportes_reporte4", array("lsubtrans" => "lsubtrans")), "html", null, true);
        echo "\";
        url = url.replace('lsubtrans', lsubtrans);
...
";
    ...
    {
        return "MainBundle:Reportes:rform4.html.twig";
    }
