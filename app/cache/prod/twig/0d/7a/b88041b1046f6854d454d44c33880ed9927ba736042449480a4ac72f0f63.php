...
<pdf>
    <dynamic-page>
        ...
        if ((isset($context["entities"]) ? $context["entities"] : null)) {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["entities"]) ? $context["entities"] : null), 0, array(), "array"), "subestacion", array()), "html", null, true);
        }
        echo "</h2>                                    
                                    </td>
                                    <td>
