...
";
    ...
    public function block_widget($context, array $blocks = array())
    {
        ...
        echo "     
                                ...
                                <div class=\"profile-info-row\">
                                    ...
                                    <div class=\"profile-info-value\">
                                        ...
                                        ";
        // line 103
        if ($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "fechaSolicitada", array())) {
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "fechaSolicitada", array()), "Y-m-d H:i:s"), "html", null, true);
        }
        // line 104
        echo "                                        </span>
                                    </div>
                                ...
                                <div class=\"profile-info-row\">
                                    ...
                                    <div class=\"profile-info-value\">
                                        ...
                                        ";
        // line 111
        if ($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "fechaAprobado", array())) {
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "fechaAprobado", array()), "Y-m-d H:i:s"), "html", null, true);
        }
        // line 112
        echo "                                        </span>
                                    </div>
        ...
        if ($this->env->getExtension('security')->isGranted("ROLE_DIRECTIVO")) {
            // line 121
            echo "                                        <a  href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("abajas_imprimir", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
            echo "\" target=\"_blank\" 
            ...
            // line 127
            echo "                                        <a  href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("bajas_imprimir", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
            echo "\" target=\"_blank\" 
                                            class=\"btn btn-pink btn-small\">
                                            <i class=\"icon-print bigger-150\"></i>
                                            Imprimir
