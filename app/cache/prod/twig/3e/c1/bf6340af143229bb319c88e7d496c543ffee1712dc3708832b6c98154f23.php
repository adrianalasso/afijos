...
/* MainBundle:Agencia:index.html.twig */
class __TwigTemplate_3ec1bf6340af143229bb319c88e7d496c543ffee1712dc3708832b6c98154f23 extends Twig_Template
{
    ...
    {
        echo "href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agencia_new"), "html", null, true);
        echo "\"";
    }
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            // line 18
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agencia_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
            ...
            echo "\">
                    ...
                    <a class=\"green\" href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agencia_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            bootbox.confirm(\"Estas seguro de eliminar registro?\", function(result) {
                if(result){
                    location.href=\"";
            // line 56
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agencia_eliminar", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\";
                }
            });
    });
...
";
    ...
    {
        return "MainBundle:Agencia:index.html.twig";
    }
