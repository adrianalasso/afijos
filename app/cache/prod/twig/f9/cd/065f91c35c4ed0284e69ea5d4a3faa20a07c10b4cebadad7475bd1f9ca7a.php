...
";
    ...
    public function block_widget($context, array $blocks = array())
    {
        ...
        echo "                                                    class=\"btn btn-primary btn-small\" id=\"bteditar\">
                                                ...
                                                <a  href=\"";
        // line 88
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("usuario_editpass", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
        echo "\" 
    ...
    public function block_datos($context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "userRoles", array()));
    ...
    public function block_linkedit($context, array $blocks = array())
    {
        // line 82
        echo "                                                <a  href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("usuario_editperfil", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
        echo "\" 
                                                     ";
    }
