...
/* MainBundle:Canton:index.html.twig */
class __TwigTemplate_dcd5e1e5bbd830f07c7f555cddd1fa72248be8b52cae1dd8d722460a3d9019a4 extends Twig_Template
{
    ...
    {
        echo "href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("canton_new"), "html", null, true);
        echo "\"";
    }
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            // line 19
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("canton_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
            ...
            echo "\">
                    ...
                    <a class=\"green\" href=\"";
            // line 27
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("canton_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            bootbox.confirm(\"Estas seguro de eliminar registro?\", function(result) {
                if(result){
                    location.href=\"";
            // line 58
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("canton_eliminar", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\";
                }
            });
    });
...
";
    ...
    {
        return "MainBundle:Canton:index.html.twig";
    }
