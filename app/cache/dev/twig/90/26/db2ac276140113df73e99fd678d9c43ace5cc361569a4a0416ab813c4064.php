...
/* MainBundle:Reportes:reporte4.html.twig */
class __TwigTemplate_9026db2ac276140113df73e99fd678d9c43ace5cc361569a4a0416ab813c4064 extends Twig_Template
{
                        ...
                        <div class=\"well well-small\">
                            <table>
                                <tr>
                                    <td width=\"80%\">
                                        <h1>C E N E L   E P </h1>
                                        <h2>Reporte de Activos en mal estado en la línea de ";
        // line 14
        if ((isset($context["entities"]) ? $context["entities"] : $this->getContext($context, "entities"))) {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["entities"]) ? $context["entities"] : $this->getContext($context, "entities")), 0, array(), "array"), "subtransmision", array()), "html", null, true);
        }
        echo "</h2>                                    
                                    </td>
                                    <td>
        ...
        if ((isset($context["entities"]) ? $context["entities"] : $this->getContext($context, "entities"))) {
            ...
            echo "                    <table  id=\"sample-table-2\" class=\"table table-striped table-bordered table-hover\">
                            <tr>
                                ...
                                <td width=\"10%\">Año de Fabricación</td>
                                <td width=\"10%\">Postería</td>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
                ...
                echo "</td>
                                    <td>";
                // line 52
                echo twig_escape_filter($this->env, $this->getAttribute($context["entity"], "anioFabricacion", array()), "html", null, true);
                echo "</td>
                                    <td>";
                // line 53
...
";
    ...
    {
        return "MainBundle:Reportes:reporte4.html.twig";
    }
