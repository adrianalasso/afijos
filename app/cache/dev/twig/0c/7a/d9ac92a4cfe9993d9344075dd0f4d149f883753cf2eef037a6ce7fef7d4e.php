...
/* MainBundle:Reportes:rform8.html.twig */
class __TwigTemplate_0c7ad9ac92a4cfe9993d9344075dd0f4d149f883753cf2eef037a6ce7fef7d4e extends Twig_Template
{
...
";
    ...
    <ul class=\"breadcrumb\">
        ...
        <li class=\"active\">Reporte de ubicación del activo</li>
    </ul><!--.breadcrumb-->
</div>
";
    }
                            ...
                            <div class=\"form-horizontal\">
                                    <div class=\"control-group\">
                                        ...
                                        <div class=\"controls\">
                                            ";
        // line 40
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "bienesCustodio", array()), 'widget', array("attr" => array("class" => "chzn-select input-large", "data-placeholder" => "Escoja una opcion..")));
        echo "
                                        </div>
                                    </div>
...
";
    ...
    {
        echo "Reporte de ubicación del activo";
    }
...
jQuery(document).ready(function() {
    var elemento=document.getElementById(\"mnrp8\");
...
\$(\"#btaceptar\").click(function(){    
    var actv = \$('#bajas_type_bienesCustodio').val();
    if(actv!=\"\"){
        var url=\"";
        // line 82
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("reportes_reporte8", array("actv" => "actv")), "html", null, true);
        echo "\";
        url = url.replace('actv', actv);
...
";
    ...
    {
        return "MainBundle:Reportes:rform8.html.twig";
    }
