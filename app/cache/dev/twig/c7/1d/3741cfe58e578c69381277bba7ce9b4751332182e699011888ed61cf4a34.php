...
class __TwigTemplate_c71d3741cfe58e578c69381277bba7ce9b4751332182e699011888ed61cf4a34 extends Twig_Template
{
...
<ul>
    ...
    <li>
        ...
        if (twig_length_filter($this->env, $this->getAttribute((isset($context["request"]) ? $context["request"] : $this->getContext($context, "request")), "routeParams", array()))) {
            // line 15
            echo "            ";
            $this->env->loadTemplate("WebProfilerBundle:Profiler:table.html.twig")->display(array("data" => $this->getAttribute((isset($context["request"]) ? $context["request"] : $this->getContext($context, "request")), "routeParams", array()), "class" => "inline"));
            // line 16
            echo "        ";
        } else {
            // line 17
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
            ...
            echo "</td>
                    <td>";
            // line 36
            echo twig_escape_filter($this->env, $this->getAttribute($context["trace"], "pattern", array()), "html", null, true);
            echo "</td>
                    <td>";
            // line 37
