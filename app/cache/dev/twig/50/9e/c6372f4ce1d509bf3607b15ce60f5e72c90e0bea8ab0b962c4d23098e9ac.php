...
/* MainBundle:Parroquia:show.html.twig */
class __TwigTemplate_509ec6372f4ce1d509bf3607b15ce60f5e72c90e0bea8ab0b962c4d23098e9ac extends Twig_Template
{
...
";
    ...
    public function block_linkedit($context, array $blocks = array())
    {
        // line 38
        echo "<a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("parroquia_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\" 
";
    }
...
";
    ...
    {
        return "MainBundle:Parroquia:show.html.twig";
    }
