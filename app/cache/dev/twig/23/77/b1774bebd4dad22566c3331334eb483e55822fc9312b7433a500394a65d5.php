...
/* MainBundle:Dependencia:index.html.twig */
class __TwigTemplate_2377b1774bebd4dad22566c3331334eb483e55822fc9312b7433a500394a65d5 extends Twig_Template
{
    ...
    {
        echo "href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("dependencia_new"), "html", null, true);
        echo "\"";
    }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            bootbox.confirm(\"Estas seguro de eliminar registro?\", function(result) {
                if(result){
                    location.href=\"";
            // line 56
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("dependencia_eliminar", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\";
                }
            });
    });
...
";
    ...
    {
        return "MainBundle:Dependencia:index.html.twig";
    }
