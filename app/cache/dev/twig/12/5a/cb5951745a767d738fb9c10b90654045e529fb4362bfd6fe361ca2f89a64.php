...
/* MainBundle:Reportes:rform5.html.twig */
class __TwigTemplate_125acb5951745a767d738fb9c10b90654045e529fb4362bfd6fe361ca2f89a64 extends Twig_Template
{
...
jQuery(document).ready(function() {
    var elemento=document.getElementById(\"mnrp5\");
...
\$(\"#btaceptar\").click(function(){    
    var lsubest = \$('#lsubestacion_type_subestacion').val();
    if(lsubest!=\"\"){
        var url=\"";
        // line 82
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("reportes_reporte5", array("lsubest" => "lsubest")), "html", null, true);
        echo "\";
        url = url.replace('lsubest', lsubest);
...
";
    ...
    {
        return "MainBundle:Reportes:rform5.html.twig";
    }
