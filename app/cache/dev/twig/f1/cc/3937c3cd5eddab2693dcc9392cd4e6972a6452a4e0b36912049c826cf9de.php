...
/* MainBundle:Subsistema:index.html.twig */
class __TwigTemplate_f1cc3937c3cd5eddab2693dcc9392cd4e6972a6452a4e0b36912049c826cf9de extends Twig_Template
{
    ...
    {
        echo "href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("subsistema_new"), "html", null, true);
        echo "\"";
    }
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            // line 18
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("subsistema_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
            ...
            echo "\">
                    ...
                    <a class=\"green\" href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("subsistema_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            bootbox.confirm(\"Estas seguro de eliminar registro?\", function(result) {
                if(result){
                    location.href=\"";
            // line 56
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("subsistema_eliminar", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\";
                }
            });
    });
...
";
    ...
    {
        return "MainBundle:Subsistema:index.html.twig";
    }
