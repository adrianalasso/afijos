...
<div class=\"profile-info-row\">
        ...
        <div class=\"profile-info-value\">
            ...
            ";
        // line 27
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "provincia", array()), "html", null, true);
        echo " 
            </span>
        </div>
</div>  
...
";
    ...
    public function block_linkedit($context, array $blocks = array())
    {
        // line 47
        echo "<a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("canton_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\" 
";
    }
