...
/* MainBundle:Reportes:rform6.html.twig */
class __TwigTemplate_13ceab9169ba8ca4eea1c0942ac55410e9eaf4d8bcebfb1312a201a2f4bec04f extends Twig_Template
{
...
";
    ...
    <ul class=\"breadcrumb\">
        ...
        <li class=\"active\">Reporte de Activos por Responsable</li>
    </ul><!--.breadcrumb-->
</div>
";
    }
...
";
    ...
    {
        echo "Reporte de Activos por Responsable";
    }
...
jQuery(document).ready(function() {
    var elemento=document.getElementById(\"mnrp6\");
...
\$(\"#btaceptar\").click(function(){    
    var emp = \$('#bienescustodio_type_trabajador').val();
    if(emp!=\"\"){
        var url=\"";
        // line 82
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("reportes_reporte6", array("emp" => "cedula")), "html", null, true);
        echo "\";
        url = url.replace('cedula', emp);
...
";
    ...
    {
        return "MainBundle:Reportes:rform6.html.twig";
    }
