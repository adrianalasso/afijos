 ...
 */
class CuentaContable extends \afijos\MainBundle\Entity\CuentaContable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'afijos\\MainBundle\\Entity\\CuentaContable' . "\0" . 'id', '' . "\0" . 'afijos\\MainBundle\\Entity\\CuentaContable' . "\0" . 'codigo', '' . "\0" . 'afijos\\MainBundle\\Entity\\CuentaContable' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CuentaContable $proxy) {
