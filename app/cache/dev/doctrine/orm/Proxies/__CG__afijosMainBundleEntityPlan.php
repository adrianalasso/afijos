 ...
 */
class Plan extends \afijos\MainBundle\Entity\Plan implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'afijos\\MainBundle\\Entity\\Plan' . "\0" . 'id', '' . "\0" . 'afijos\\MainBundle\\Entity\\Plan' . "\0" . 'descripcion');
        }
